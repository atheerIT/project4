...
class Post(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='geek')
...
class UserFollow(models.Model):
    ...
    following = models.ForeignKey(
        User, related_name='followres', on_delete=models.CASCADE, default=None)
...
class UserLikes(models.Model):
    ...
    post = models.ForeignKey(
        Post, on_delete=models.CASCADE, related_name='likedPosts')
